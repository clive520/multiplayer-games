...
export default function Lobby() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-3xl p-6">
      ...
      {cleanupInfo && (
        <div className="mb-4 rounded-lg border dark:border-slate-600 border-app-border-strong dark:bg-slate-800 bg-app-card p-3 text-sm dark:text-slate-300 text-slate-700">
          {cleanupInfo}
        </div>
      )}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border dark:border-slate-700 border-app-border dark:bg-slate-800 bg-app-card p-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <div className="flex rounded-md border dark:border-slate-600 border-app-border-strong p-0.5">
                <button
                  type="button"
                  ...
                  className={`rounded px-2 py-1 text-xs font-medium transition ${
                    createMode === 'pvp'
                      ...
                      : 'dark:bg-slate-700 bg-app-card dark:text-slate-200 text-slate-800 hover:dark:bg-slate-600 hover:bg-app-hover'
                  }`}
                >
              ...
              <>
                ...
                <label className="mb-3 flex cursor-pointer items-center gap-2 text-sm dark:text-slate-300 text-slate-700">
                  <input
                    ...
                    className="h-4 w-4 rounded dark:border-slate-600 border-app-border-strong"
                  />
                ...
                {usePassword && (
                  <input
                    ...
                    maxLength={6}
                    className="mb-2 w-full rounded border dark:border-slate-600 border-app-border-strong dark:bg-slate-900 bg-slate-50 px-3 py-2 text-center text-lg tracking-widest"
                  />
                )}
              </>
            )}
          ...
          >
            ...
            <input
              ...
              maxLength={6}
              className="mb-2 w-full rounded border dark:border-slate-600 border-app-border-strong dark:bg-slate-900 bg-slate-50 px-3 py-2 text-center text-lg tracking-widest uppercase"
            />
            <button
              type="submit"
        ...
        <div className="mb-4 rounded-lg border border-yellow-700 bg-yellow-900/20 p-4">
          ...
          <form onSubmit={handleJoinWithPassword} className="flex gap-2">
            <input
              ...
              maxLength={6}
              autoFocus
              className="flex-1 rounded border dark:border-slate-600 border-app-border-strong dark:bg-slate-900 bg-slate-50 px-3 py-2 text-center text-lg tracking-widest"
            />
            <button
              type="submit"
            ...
            <button
              ...
              className="rounded-lg dark:bg-slate-700 bg-app-hover px-4 py-2 dark:text-slate-300 text-slate-700 hover:dark:bg-slate-600 bg-app-border-strong"
            >
              {t('common.cancel')}
            </button>
          </form>
      ...
      <section>
        ...
        {lobbyError ? (
          ...
          <p className="rounded-lg border border-dashed dark:border-slate-700 border-app-border p-8 text-center text-slate-500">
            {t('lobby.noRooms')}
          </p>
        ) : (
              ...
              return (
                <li key={room.id} className="group relative">
                  <button
                    ...
                    className="w-full rounded-lg border dark:border-slate-700 border-app-border dark:bg-slate-800 bg-app-card p-4 text-left hover:border-slate-500"
                  >
